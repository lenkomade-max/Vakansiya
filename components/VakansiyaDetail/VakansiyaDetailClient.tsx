        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6 sticky top-6">
                            ...
                            <div>
                                <p className="text-sm text-gray-600 mb-2">
                                    {vakansiya.employer_phone ? 'İşəgötürən:' : (vakansiya.contact_name ? 'Əlaqə şəxsi:' : 'Əlaqə:')}
                                </p>
                                {!vakansiya.employer_phone && vakansiya.contact_name && (
                                    <p className="text-base font-semibold text-black mb-3">
                                        {vakansiya.contact_name}
                                    </p>
                                )}
                                ...
                                {!showPhone ? (
                                    ...
                                    >
                                        ...
                                        {vakansiya.employer_phone ? 'Nömrəni göstər' : 'Əlaqə'}
                                    </button>
                                ) : (
                                    <div className="space-y-3">
                                        <a
                                            href={`tel:${vakansiya.employer_phone || vakansiya.contact_phone}`}
                                            className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-black text-white rounded-xl font-bold text-base hover:bg-gray-800 transition-all active:scale-95"
                                        >
                                            <PhoneIcon className="w-5 h-5" />
                                            {vakansiya.employer_phone || vakansiya.contact_phone}
                                        </a>
                                        <a
                                            href={`https://wa.me/${(vakansiya.employer_phone || vakansiya.contact_phone).replace(/\D/g, '')}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
            ...
            <footer className="bg-white border-t border-gray-200 py-8 md:py-12 mt-12">
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="border-t border-gray-200 mt-6 md:pt-8 pt-6 md:mt-8 text-center text-xs md:text-sm text-gray-600">
                        © 2025 Vakansiya.az
                    </div>
                </div>
            </footer>
